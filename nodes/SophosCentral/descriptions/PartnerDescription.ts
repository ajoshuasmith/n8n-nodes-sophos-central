	...
	},
	{
		...
		options: [
			{ name: 'Current Month', value: 7 },
			{
				...
				description: 'Comma-separated tenant IDs for scoped access. Leave empty for Partner-level access.',
			},
		],
	},
		...
		options: [
			{
				...
				default: '',
				placeholder: 'e.g. a1b2c3d4-e5f6-7890-abcd-ef1234567890',
				description: 'Filter billing report for a specific Sophos account',
			},
		],
	},
